...
<div class="mail-container">
    <div class="logo-wrapper">
        <a href="{{url('/')}}">
            <img src="{!! get_attachment_image(get_static_option('general_site_logo')) !!}" alt="{{ __('Image Not Found!') }}">
        </a>
    </div>
    <div class="inner-wrap">
        <p >{{__('Hello,')}} <br >{{__('you have a new message from').' '. get_static_option('general_site_section_'.get_default_language().'_title')}}</p>
        <table >
