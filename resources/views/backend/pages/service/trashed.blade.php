                                            ...
                                            <tbody >
                                                @foreach($service as $data)
                                                    <tr >
                                                        ...
                                                        <td >
                                                            <div class="d-flex">
                                                                @include('backend.partials.delete-with-swal', ['url' => route('admin.services.trashed.delete', $data->id)])
                                                                <a class="btn btn-primary btn-sm me-1" href="{{ route('admin.services.restore', $data->id) }}">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#bulk_delete_btn', function (e) {
                ...
                if (allIds.length > 0 && bulkOption == 'delete') {
                    ...
                    axios.delete(route('admin.services.bulk.action.trashed'), {
                        data: {
                            ids: allIds,
                            _token: "{{csrf_token()}}",
                        }
