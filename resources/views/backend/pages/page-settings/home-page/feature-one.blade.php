    ...
    <div class="col-lg-12 col-ml-12">
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{__('Feature Area One Settings')}}</h4>

                        <form action="{{route('admin.home-page.feature.one')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <nav >
                            ...
                            <div class="tab-content mt-4" id="nav-tabContent">
                                <div class="mb-3">
                                    ...
                                    <select name="feature_one_{{get_static_option('home_page_variant')}}_id[]" class="form-select select2_tags" multiple="multiple" id="tagsInput">
                                        @php
                                            $featureItems = 'feature_one_' . get_static_option('home_page_variant') . '_id';
                                            ...
                                            <tbody >
                                                @foreach($features as $data)
                                                    <tr >
                                                        ...
                                                        <td >
                                                            @include('backend.partials.delete-with-swal', ['url' => route('admin.feature.item.destroy', $data->id)])
    ...
    <div class="modal fade" id="add_featrue_item" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('admin.feature.item.store')}}" method="post">
    ...
    <div class="modal fade" id="feature_item_edit_modal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('admin.feature.item.update')}}" method="post">
                    <div class="modal-body">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" id="feature_item_title" class="form-control">
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="feature_item_description">{{__('Description')}}</label>
                            <textarea name="description" class="form-control" id="feature_item_description" cols="30" rows="5"></textarea>
                        </div>
                        <div class="mb-3">
