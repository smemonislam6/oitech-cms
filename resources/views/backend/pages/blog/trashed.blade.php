                        ...
                        <div class="row  align-items-center">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <form action="{{ route('admin.blog.trashed') }}" method="GET" onchange="this.submit()">
                                            <div class="row">
                        ...
                        <div class="tab-content mt-4" id="myTabContent">
                            ...
                            <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="slider_tab_{{ $key }}" role="tabpanel">
                                <div class="table-wrap table-responsive">
                                    <table class="table table-default align-middle" id="trashed_table">
                                        <thead>
                                            <th class="no-sort">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        @include('backend.partials.delete-with-swal', ['url' => route('admin.blog.trashed.delete', $data->id)])
                                                        <a class="btn btn-primary btn-sm me-1" href="{{ route('admin.blog.restore', $data->id) }}">
        ...
        $(document).ready(function() {
            $(document).on('click', '#bulk_delete_btn', function (e) {
                ...
                if (allIds.length > 0 && bulkOption == 'delete') {
                    ...
                    axios.delete(route('admin.blog.bulk-action.trashed'), {
                        data: {
                            ids: allIds,
                            _token: "{{csrf_token()}}",
                        }
