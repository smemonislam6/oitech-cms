    ...
    <div class="col-lg-12 col-md-12">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{__('Testimonial')}}</h4>
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <a href="{{ route('admin.testimonials.create') }}" class="d-none d-sm-inline-block btn btn-primary shadow-sm"> <i class="ri-add-line"></i>{{ __('Add Item') }}</a>
                        </div>
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            @foreach($all_testimonial as $key => $team)
                                                    ...
                                                    <tr >
                                                        ...
                                                        <td >
                                                            <div class="photo-container">
                                                                <a href="{{ asset($data->TestimonialImageUrl) }}" class="magnific">
                                                                    <img src="{{ asset($data->TestimonialImageUrl) }}" alt="{{ $data->name }}">
                                                                </a>
                                                            </div>
                                                        </td>
                                                        <td >{{$data->name}}</td>
                                                        ...
                                                        <td >
                                                            @include('backend.partials.delete-with-swal', ['url' => route('admin.testimonials.destroy', $data->id)])
                                                            <a href="{{route('admin.testimonials.edit',$data->id)}}" class="btn btn-primary btn-sm me-1">
                                                                <i class="ri-pencil-line"></i>
                                                            </a>
                                                            <form action="{{ route('admin.testimonials.clone', $data->id) }}" method="post" style="display: inline-block">
                                                                @csrf
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#bulk_delete_btn', function (e) {
                ...
                if (allIds.length > 0 && bulkOption == 'delete') {
                    ...
                    axios.delete(route('admin.testimonials.bulk.action'), {
                        data: {
                            ids: allIds,
                            _token: "{{csrf_token()}}",
                        }
